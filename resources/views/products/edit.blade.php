                ...
                <div class="form-group">
                    {!! Form::label('tech_spec_pdf', 'tech spec pdf:') !!}
                     {!! Form::file('tech_spec_pdf', array('class' => '')) !!}
                      ...
                      <a href="<?php echo config('app.url'); ?>suppliers/<?php echo str_slug($product->company->comp_name);?>/products/<?php echo $product->tech_spec_pdf;?>">View Pdf</a>
                     @endif
                </div>
                <div class="form-group">
