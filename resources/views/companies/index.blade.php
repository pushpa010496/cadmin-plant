...
<div class="content">
        <div class="col-md-offset-2 col-md-8 col-md-offset-2">
             ...
             <div class="col-md-12">
          {!! Form::open(['method'=>'GET','url'=>'companies','role'=>'search'])  !!}
                        ...
                        @foreach($companies as $value)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn btn-sm btn-success" href="{{ url('companies/reactivate', $value->id) }}">
                                         Active ?
                                    </a>
                                  ...
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          {!! Form::open(array('route'=>['companies.meta','id'=>$value->id])) !!}
                                             @includeIf('./seoform')
                                          {!! Form::close() !!}
                                      </div>
