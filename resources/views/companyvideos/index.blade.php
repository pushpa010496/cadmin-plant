...
<div class="content">
        <div class="col-md-offset-2 col-md-8 col-md-offset-2">
             <div class="page-header clearfix">
                <h3>
                     Company Videos
                    <a class="btn btn-success pull-right" href="{{ route('companyvideos.create') }}"><i class="fa fa-plus-square-o" aria-hidden="true"></i>  Create</a>
                </h3>               
            </div>
             <div class="col-md-12">
          {!! Form::open(['method'=>'GET','url'=>'companyvideos','role'=>'search'])  !!}
        ...
        <div class="col-md-offset-2 col-md-8 col-md-offset-2">
            @if($companyvideos->count())
                <table class="table table-condensed table-striped">
                    ...
                    <tbody><?php $i=1; ?>
                        @foreach($companyvideos as $value)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn btn-sm btn-success" href="{{ url('companyvideos/reactivate', $value->id) }}">
                                         Active ?
                                    </a>
                                    <a class="btn btn-sm btn-primary" href="{{ route('companyvideos.show', $value->id) }}">
                                        <i class="fa fa-eye" aria-hidden="true"></i> View
                                    </a>
                                    
                                    <a class="btn btn-sm btn-warning" href="{{ route('companyvideos.edit', $value->id) }}">
                                       <i class="fa fa-pencil-square" aria-hidden="true"></i> Edit
                                    </a>

                                    <form action="{{ route('companyvideos.destroy', $value->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Delete? Are you sure?');">
                                        {{csrf_field()}}
                                  ...
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          {!! Form::open(array('route'=>['video.meta',$value->id])) !!}
                                             @includeIf('./seoform')
                                          {!! Form::close() !!}
                                      </div>
