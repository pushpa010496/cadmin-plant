        ...
        <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    {{ Form::select('pages[]', $pages, null, ['class' => 'form-control page_list','required'=>'required','multiple'=>'multiple','placeholder'=>'Select Page']) }}
                </div>
                ...
                <div class="form-group" id="suppliers">
                    ...
                    {{ Form::select('suppliers[]', $suppliers, null, ['class' => 'form-control','multiple'=>'multiple','placeholder'=>'Select supplier alphabets']) }}
                </div>  
                <!-- <div class="form-group" id="categories">
                    {!! Form::label('category', 'Categories:') !!}
                    {{ Form::select('catego[]', $category, null, ['class' => 'form-control','required'=>'required','multiple'=>'multiple','placeholder'=>'Select Page','id'=>'cat_banner']) }}
                </div> -->
                <div class="form-group">
...
@section('scripts')
  ...
  //   $('#cat_banner').change(function(){
  //     var cat =  $('#cat_banner').val();
