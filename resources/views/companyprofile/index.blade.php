...
<div class="content">
        <div class="col-md-offset-2 col-md-8 col-md-offset-2">
             <div class="page-header clearfix">
                <h3>
                     Company Profile
                    <a class="btn btn-success pull-right" href="{{ route('companyprofile.create') }}"><i class="fa fa-plus-square-o" aria-hidden="true"></i>  Create</a>
                </h3>               
            </div>
             <div class="col-md-12">
          {!! Form::open(['method'=>'GET','url'=>'companyprofile','role'=>'search'])  !!}
                        ...
                        @foreach($companyprofile as $value)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn btn-sm btn-success" href="{{ url('companyprofile/reactivate', $value->id) }}">
                                         Active ?
                                    </a>
                                    <a class="btn btn-sm btn-primary" href="{{ route('companyprofile.show', $value->id) }}">
                                        <i class="fa fa-eye" aria-hidden="true"></i> View
                                    </a>
                                    
                                    <a class="btn btn-sm btn-warning" href="{{ route('companyprofile.edit', $value->id) }}">
                                       <i class="fa fa-pencil-square" aria-hidden="true"></i> Edit
                                    </a>

                                    <form action="{{ route('companyprofile.destroy', $value->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Delete? Are you sure?');">
                                        {{csrf_field()}}
                                  ...
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          {!! Form::open(array('route'=>['profile.meta',$value->id])) !!}
                                             @includeIf('./seoform')
                                          {!! Form::close() !!}
                                      </div>
