    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            ...
            <form action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    {!! Form::label('img_alt', 'news Img Alt:') !!}
                    {{ Form::input('text', 'img_alt', old('img_alt',$news->img_alt), ['class' => 'form-control']) }}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {{ Form::input('text', 'news_url', old('news_url',$news->news_url), ['class' => 'form-control']) }}
                </div>
                <div class="form-group">
