...
@section('header')
    <div class="page-header">
        <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> Whitepapers / Create </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
                {!! Form::open(array('route' => 'whitepapers.store','files'=>true)) !!}                
                ...
                <div class="form-group">
                    ...
                    {{ Form::input('text', 'whitepapers_url', null, ['class' => 'form-control']) }}
                </div>
