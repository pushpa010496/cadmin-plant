...
@section('header')
    <div class="page-header">
        <h3><i class="fa fa-pencil-square" aria-hidden="true"></i> Mediapack / Edit </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            ...
            <form action="{{ route('mediapack.update', $newsletter->id) }}" method="POST" enctype="multipart/form-data">
