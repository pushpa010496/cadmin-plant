...
@section('header')
    <div class="page-header">
        <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i>  Company WhitePaper / Create </h3>
    </div>
@endsection
     ...
     <div class="row">
        <div class="col-md-offset-3 col-md-6 col-md-offset-3">
               ...
               <div class="well well-sm">
                    ...
                    <a class="btn btn-sm btn-default pull-right" href="{{ route('companywhitepapers.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
                </div>  
