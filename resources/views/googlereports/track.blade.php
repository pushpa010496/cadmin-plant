...
<div class="col-lg-12">
 ...
 <section class="content">
  ...
  <div class="box-body">
    <form action="{{ url('analyticaltrackreports') }}" method="post">
      {{csrf_field()}}
    <div class="row">
            <div class="col-md-2">
           ...
           <label>Select Region <span style="color: #FF0000">*</span></label>
                <select class="form-control" id="region" name="region" required onchange="regionOnchange(this.value)">
           ...
           <label>Select Sub Region <span style="color: #FF0000">*</span></label>
                <select class="form-control" id="sub_region" name="sub_region" required onchange="subRegionOnchange(this.value)">
...
//alert("Please select startdate");
 ...
 $('#startdate').datepicker({
  ...
  function regionOnchange(region_id)
  {
     //alert(region_id);
       $.ajax({
          ...
          success: function (response) {
              $('select[name="sub_region"]').empty();
          $('select[name="sub_region"]').append('<option value="">--Select Sub Regions--</option>');
              $.each(response, function(key, value) {
          $('select[name="sub_region"]').append('<option value="'+ value.id +'">'+ value.name +'</option>');
            });
            
          },
       });
  }
  function subRegionOnchange(sub_region)
  {
     //alert(sub_region);
