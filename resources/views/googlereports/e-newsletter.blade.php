...
<section class="content">
  <div class="box-body">
    <form action="{{ url('analyticalenewsreports') }}" method="post">
    {{csrf_field()}}
    ...
    <div class="row">
        ...
        <div class="col-md-3">
        <div class="form-group">
          <label>Select Enewsletters<span style="color: #FF0000">*</span></label>
          <select class="form-control select2" id="shorturlid" name="shorturl" style="width: 100%;" required>
            <option selected="selected" value="ochre">--Select Enewsletters--</option>
