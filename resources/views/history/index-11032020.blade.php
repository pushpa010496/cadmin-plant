      ...
      <table class="table table-condensed table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <h5>{{$value->comp_name}}</h5>
            </td>
            <td>
              <h5>{{$value->active_flag == 1 ? 'Active':'In Active'}}</h5>
            </td>
            <td>
              <h5>{{$value->profile_type}}</h5>
            </td>
            <td class="text-right">
...
<ul ui-scroll-viewport style="overflow-y: scroll; height: 350px;margin: 20px;margin-left: -40px;
  ...
  <li style="width:100%">
    <div class="msj macro">
      <div class="avatar"><img class="img-circle" style="width:100%;" src="https://www.ochre-media.com/images/logo.png"></div>
      <div class="text text-l" id="result" >
        <p ></p>
        <p><small>3:20 PM</small></p>
      </div>
    </div>
  </li>
  --}}
